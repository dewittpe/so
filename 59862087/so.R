...
reprex(
{
  ...
  #' When building the `dplyr::summarize` call you can use the `qwraps2::frmtct`
  #' call to format the output of `qwraps2::mean_ci` into a character string of
  #' length one.
  #'
  #' I would also recommend using the data pronoun `.data` so you can be
  #' explicit about the variables to summarize.
